...
public class ScienceFairTableAssignmentApp {
    ...
    private static void generateHtmlLayout(List<SlotAssignment> assignments, String outputFile) {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(outputFile))) {
            ...
            writer.println("        .legend { margin-top: 40px; padding: 30px; background: linear-gradient(135deg, #f8f9fa, #e9ecef); border-radius: 12px; }");
            writer.println("        .legend h3 { color: #495057; margin-bottom: 20px; font-size: 1.4em; font-weight: 500; }");
            writer.println("        .legend-table { font-size: 14px; width: 100%; }");
            writer.println("        .legend-table td { padding: 8px 12px; vertical-align: middle; }");
            writer.println("        .legend-sample { width: 60px; height: 35px; border-radius: 6px; }");
            ...
            writer.println("            <p><strong>💡 Note:</strong> T### = Table Number (snake flow), P### = Project ID. Team projects are marked with 👥</p>");
            writer.println("        </div>");
