...
public class ScienceFairTableAssignmentApp {
    ...
    private static void generateHtmlLayout(List<SlotAssignment> assignments, String outputFile) {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(outputFile))) {
            ...
            writer.println("        .anim { border-color: #38a169 !important; box-shadow: inset 0 0 0 2px #38a169 !important; }");
            writer.println("        .behv { border-color: #3182ce !important; box-shadow: inset 0 0 0 2px #3182ce !important; }");
            writer.println("        .bioc { border-color: #b7791f !important; box-shadow: inset 0 0 0 2px #b7791f !important; }");
            writer.println("        .biom { border-color: #c05621 !important; box-shadow: inset 0 0 0 2px #c05621 !important; }");
            writer.println("        .chem { border-color: #2c7a7b !important; box-shadow: inset 0 0 0 2px #2c7a7b !important; }");
            writer.println("        .cbio { border-color: #3c366b !important; box-shadow: inset 0 0 0 2px #3c366b !important; }");
            writer.println("        .cell { border-color: #805ad5 !important; box-shadow: inset 0 0 0 2px #805ad5 !important; }");
            writer.println("        .comp { border-color: #2c7a7b !important; box-shadow: inset 0 0 0 2px #2c7a7b !important; }");
                        ...
                        writer.println("        .empty { border-color: #a0aec0 !important; box-shadow: inset 0 0 0 2px #a0aec0 !important; background: linear-gradient(135deg, #f7fafc, #edf2f7); color: #a0aec0; border-left: 4px solid #cbd5e0; min-height: 38px; height: 38px; }");
                        writer.println("        .empty.reserved { background: linear-gradient(135deg, #ffe6e6, #ffd6d6); color: #b80000; border-left: 4px solid #ff6b6b; box-shadow: inset 0 0 0 2px #ff6b6b !important; min-height: 38px; height: 38px; }");
            ...
            writer.println("        .anim.legend-sample { border: 1px solid #16a34a !important; }");
            writer.println("        .behv.legend-sample { border: 1px solid #2563eb !important; }");
            writer.println("        .bioc.legend-sample { border: 1px solid #d97706 !important; }");
            writer.println("        .biom.legend-sample { border: 1px solid #ea580c !important; }");
            writer.println("        .chem.legend-sample { border: 1px solid #059669 !important; }");
            writer.println("        .cbio.legend-sample { border: 1px solid #be185d !important; }");
            writer.println("        .cell.legend-sample { border: 1px solid #7c3aed !important; }");
            writer.println("        .comp.legend-sample { border: 1px solid #0284c7 !important; }");
            writer.println("        .eaev.legend-sample { border: 1px solid #22c55e !important; }");
            writer.println("        .eemr.legend-sample { border: 1px solid #9333ea !important; }");
            writer.println("        .eemt.legend-sample { border: 1px solid #f97316 !important; }");
            writer.println("        .math.legend-sample { border: 1px solid #ca8a04 !important; }");
            writer.println("        .mcro.legend-sample { border: 1px solid #0ea5e9 !important; }");
            writer.println("        .phys.legend-sample { border: 1px solid #c026d3 !important; }");
            writer.println("        .plnt.legend-sample { border: 1px solid #65a30d !important; }");
            writer.println("        .prod.legend-sample { border: 1px solid #e11d48 !important; }");
            writer.println("        .empty.legend-sample { border: 1px solid #cbd5e0 !important; }");
            writer.println("        .empty.reserved.legend-sample { border: 1px solid #ff6b6b !important; }");
            ...
            // New two-column legend layout using CSS grid (replaces previous table for space efficiency)
            writer.println("        .legend-grid { display: grid; grid-template-columns: repeat(2, minmax(0,1fr)); column-gap: 20px; row-gap: 4px; }");
            writer.println("        .legend-item { display: flex; align-items: center; font-size: 11px; line-height: 1; }");
            writer.println("        .legend-item .legend-sample { margin-right: 4px !important; }");
            writer.println("        .legend-item span { line-height: 1; }");
            writer.println("        @media (max-width: 700px) { .legend-grid { grid-template-columns: 1fr; } }");
            writer.println("        .legend-sample { width: 32px !important; height: 16px !important; min-height: 16px !important; border-radius: 3px; font-size: 8px; display: flex; align-items: center; justify-content: center; border: 1px solid transparent !important; padding: 0 !important; }");
            ...
            writer.println("                <div class='legend-item'><div class='slot anim legend-sample'></div><span>Animal Sciences (ANIM)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot behv legend-sample'></div><span>Behavioral & Social Sciences (BEHV)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot bioc legend-sample'></div><span>Biochemistry (BIOC)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot biom legend-sample'></div><span>Biomedical/Health Sci & Eng (BIOM)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot cell legend-sample'></div><span>Cellular & Molecular Biology (CELL)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot chem legend-sample'></div><span>Chemistry (CHEM)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot cbio legend-sample'></div><span>Computational Bio & Info (CBIO)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot comp legend-sample'></div><span>Computer Science (COMP)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot eaev legend-sample'></div><span>Earth & Environmental Sci (EAEV)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot eemr legend-sample'></div><span>Eng: Electrical, Mech, Robotics (EEMR)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot eemt legend-sample'></div><span>Eng: Energy, Materials, Transport (EEMT)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot math legend-sample'></div><span>Mathematics (MATH)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot mcro legend-sample'></div><span>Microbiology (MCRO)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot phys legend-sample'></div><span>Physics & Astronomy (PHYS)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot plnt legend-sample'></div><span>Plant Sciences (PLNT)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot prod legend-sample'></div><span>Product Testing (PROD)</span></div>");
            writer.println("                <div class='legend-item'><div class='slot empty legend-sample'>EMPTY</div><span>Unassigned slot</span></div>");
            writer.println("                <div class='legend-item'><div class='slot empty reserved legend-sample'>RSRVD</div><span>Reserved slot</span></div>");
            writer.println("            </div>");
